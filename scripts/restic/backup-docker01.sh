...
declare -a FOLDER_PATHS=("/home/homelab/privatelab/docker-compose/traefik/srv", "/home/homelab/privatelab/docker-compose/core-keeper/srv", "/home/homelab/privatelab/docker-compose/dashy/srv", "/home/homelab/privatelab/docker-compose/freshrss/srv", "/home/homelab/privatelab/docker-compose/gotify/srv", "/home/homelab/privatelab/docker-compose/joplin/srv", "/home/homelab/privatelab/docker-compose/pihole/srv")
...
curl "https://gotify.mpierce.net/message?token=FFFFFFFFF" -F "title=Docker01 Backups Complete" -F "message=restic backup script for finished at $(datestring) in ${delta}" -F "priority=5"