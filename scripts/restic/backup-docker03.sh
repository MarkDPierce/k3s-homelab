...
declare -a FOLDER_PATH=("/home/homelab/privatelab/docker-compose/traefik/srv")
...
curl "https://gotify.mpierce.net/message?token=FFFFFFFFFFFF" -F "title=Docker03 Backups Complete" -F "message=restic backup script for finished at $(datestring) in ${delta}" -F "priority=5"